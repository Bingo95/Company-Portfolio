...
<html lang="zh-cmn-Hans">
			...
			<div class="weui-popup__modal">
				...
				<div class="weui-cells weui-cells_form pub_about_box">
					<div class="weui-cell pub_about_lt">
						...
						<div class="weui-cell__bd">
							<input id="sysname_modify" class="weui-input" type="text" maxlength="15">
						</div>
					</div>
					<div class="weui-cell pub_about_lt">
						<div class="weui-cell__hd">
	...
	<script src="js/c_navbar_pub.js" type="text/javascript" charset="utf-8"></script>
	<script src="js/c_publist.js" type="text/javascript" charset="utf-8"></script>
